  ...
  return (
    <div className="bg-white min-h-screen">
      <div className="max-w-xl mx-auto px-4 sm:px-6 py-20 text-center">
        ...
        <div className="w-16 h-16 bg-[var(--green)] rounded-full flex items-center justify-center mx-auto mb-6">
        ...
        {product && (
          <div className="bg-[var(--gray-bg)] border border-gray-200 rounded-xl p-4 mb-8 text-left">
            <p className="text-xs text-[var(--gray)] uppercase tracking-wide mb-1">Your order</p>
            <p className="font-semibold text-[var(--navy)]">{product.name}</p>
        ...
        <div className="space-y-4 mb-10 text-left">
          {[
            ...
            <div key={item.title} className="flex gap-4 p-4 bg-[var(--gray-bg)] rounded-xl border border-gray-200">
              <span className="text-2xl">{item.icon}</span>
              <div>
                <p className="font-semibold text-[var(--navy)] text-sm mb-0.5">{item.title}</p>
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Link
            href="/dashboard"
            className="inline-flex items-center justify-center gap-2 bg-[var(--navy)] text-white font-semibold px-6 py-3 rounded-lg hover:bg-[var(--navy-dark)] transition-colors text-sm"
          >
            Go to your dashboard
          </Link>
          <Link
            href="/"
            className="inline-flex items-center justify-center gap-2 border border-gray-200 text-[var(--navy)] font-medium px-6 py-3 rounded-lg hover:border-[var(--navy)] transition-colors text-sm"
          >
            Back to home
          </Link>
        </div>

        <p className="mt-8 text-xs text-[var(--gray-light)]">
          Questions? Email{" "}
