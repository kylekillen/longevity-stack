...
export const metadata = {
  title: "How We Make Money — Longevity Stack",
  description: "Full transparency on how Longevity Stack earns revenue through affiliate commissions.",
};

export default function HowWeMakeMoneyPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-8 sm:py-12">
      <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">How We Make Money</h1>

      <div className="prose prose-gray max-w-none">
        <p className="text-lg text-gray-600 mb-8">
          Full transparency. No fine print. Here&apos;s exactly how Longevity Stack generates revenue.
        </p>

        <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Affiliate Commissions</h2>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200">
                <th className="text-left py-2 pr-4 font-medium text-gray-500">Retailer</th>
                <th className="text-right py-2 pr-4 font-medium text-gray-500">Commission</th>
        ...
        <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Our Commitments</h2>

        <div className="space-y-4 mb-8">
          <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-4">
            <h3 className="font-semibold text-emerald-900 mb-1">We always show the cheapest option</h3>
          ...
          <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-4">
            <h3 className="font-semibold text-emerald-900 mb-1">We flag authenticity risks</h3>
            <p className="text-sm text-emerald-800">
              We don&apos;t hide the{" "}
          ...
          <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-4">
            <h3 className="font-semibold text-emerald-900 mb-1">No sponsored placements</h3>
            <p className="text-sm text-emerald-800">
          ...
          <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-4">
            <h3 className="font-semibold text-emerald-900 mb-1">No hidden fees or markups</h3>
            <p className="text-sm text-emerald-800">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-4">What This Costs to Run</h2>
        <div className="overflow-x-auto mb-6">
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200">
                <th className="text-left py-2 pr-4 font-medium text-gray-500">Expense</th>
                <th className="text-right py-2 font-medium text-gray-500">Monthly Cost</th>
              </tr>
            </thead>
            <tbody className="text-gray-600">
              <tr className="border-b border-gray-100">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-4">What We Don&apos;t Do</h2>
