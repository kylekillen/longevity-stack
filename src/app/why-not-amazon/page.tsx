...
export const metadata = {
  title: "Why We Don't Recommend Amazon for Supplements — Longevity Stack",
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8 sm:py-12">
      ...
      <div className="prose prose-gray max-w-none">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-4">The 57% Failure Rate</h2>
        ...
        <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Commingled Inventory: The Root Cause</h2>
        <p className="text-gray-600 mb-4">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Brands Are Sounding the Alarm</h2>
        ...
        <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-4">The Temperature Problem</h2>
        <p className="text-gray-600 mb-4">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-4">When We Do Recommend Amazon</h2>
        <p className="text-gray-600 mb-4">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Our Recommended Retailers</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
          {[
            ...
            <div key={v.name} className="border border-gray-200 rounded-lg p-4">
              <div className="flex items-center gap-2 mb-1">
                <span className="text-sm font-semibold text-gray-900">{v.name}</span>
                <span className="text-xs bg-green-100 text-green-700 px-1.5 py-0.5 rounded">{v.trust}/10</span>
              </div>
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 text-center">
          <p className="text-gray-600 mb-4">Ready to build a stack from vetted retailers?</p>
          <Link
            href="/ingredients"
